...
st.markdown("""
    ...
    div.stButton > button { background-color: #00A335 !important; color: white !important; border-radius: 25px !important; }
    </style>
...
if admin_id:
    ...
    if estado['pago_confirmado']:
        ...
        foto = st.camera_input("Foto comprobante")
        if foto and st.button("Enviar"):
    ...
    with tab2:
        ...
        if st.button("Generar"):
            ...
            # ... (código inserción participantes)
            st.success("¡Creada!")
